      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              href="tel:+13152152005"
              className="text-gray-700 font-semibold flex items-center"
            >
              <span className="text-xl border-2 border-blue-600 border-solid p-2 rounded-md">
                +1 315 215 2005
              </span>
            </a>
          </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-200">
          ...
          <p className="text-gray-600 mb-6 flex">
            ...
            one business day to discuss options and pricing.
          </p>
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105 flex items-center justify-center"
            >
